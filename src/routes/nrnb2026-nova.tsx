...
export function NewNrnbLanding({ page = "/nrnb2026-nova" }: { page?: string }) {
  ...
  return <main className="nrnb2026-nova-page min-h-screen overflow-x-clip bg-background pb-16 lg:pb-0"><Ticker/><Hero campaign={campaign}/><Navigation/><Identification/><Presentation campaign={campaign}/><Benefits/><Topics campaign={campaign}/><EventExperience/><Speakers/><Schedule campaign={campaign}/><SocialProof/><Fair/><Tickets campaign={campaign}/><AboutSuelen/><Closing/><Faq/><FinalCTA/><Footer/><StickyCTA/><WhatsApp/></main>;
}
