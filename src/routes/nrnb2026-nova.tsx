...
function LogoDivider() { return <div className="bg-surface px-5 py-10 sm:px-6 sm:py-14"><img src={logoNrnb.url} alt="Não Repara na Bagunça" loading="lazy" className="mx-auto w-40 sm:w-52" /></div>; }
