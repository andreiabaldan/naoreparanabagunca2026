...
const TICKETS: Ticket[] = [
  { id: "compromisso", name: "Compromisso", price: "147,00", installment: "15,11", cta: "QUERO MEU INGRESSO", event: "ticket_compromisso_click", checkout: "https://payfast.greenn.com.br/pre-checkout/xa37xct", benefits: ["Você sai sabendo o que começar a aplicar na sua casa e na sua rotina.", "Acesso aos 2 dias de evento", "Acesso à feira Não Repara na Bagunça"] },
  { id: "vip", name: "VIP", price: "197,00", installment: "20,25", cta: "QUERO SER VIP", event: "ticket_vip_click", checkout: "https://payfast.greenn.com.br/pre-checkout/xa37xct", badge: "Experiência recomendada", includesFrom: "TUDO DO INGRESSO COMPROMISSO +", benefits: ["Assentos em áreas mais à frente da plateia", "Acesso à área VIP exclusiva", "Café e petit four"] },
...
export function NewNrnbLanding({ page = "/nrnb2026-nova" }: { page?: string }) {
  ...
  return <main className="nrnb2026-nova-page min-h-screen overflow-x-clip bg-background pb-16 lg:pb-0"><Ticker/><Navigation/><Hero campaign={campaign}/><Identification campaign={campaign}/><Presentation campaign={campaign}/><Benefits/><Topics campaign={campaign}/><EventExperience/><Speakers/><Schedule/><SocialProof/><Fair/><Tickets campaign={campaign}/><AboutSuelen/><Closing/><Faq/><FinalCTA/><Footer/><StickyCTA/><WhatsApp/></main>;
}
